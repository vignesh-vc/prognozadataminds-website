                    ...
                    >
                        ...
                        <div className="max-w-4xl mx-auto space-y-6 text-gray-700">
                            ...
                            <p className="text-gray-700 text-md sm:text-md leading-relaxed text-justify">
                                Our team is proficient in various fields including <span className="font-medium text-[#00CD97]">data mining, interpretation, analytics, and management, enabling us to deliver outstanding KOL Identification and profiling services.</span> We help businesses build and sustain a comprehensive KOL database while adhering to client quality standards, consistently meeting deadlines, and achieving exceptional results.
                            </p>
                        </div>
                    </motion.div>
